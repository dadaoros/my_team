...
import com.mugen.myteam.Presenter.ApiManager.DownloadTeamsHandler;
...
import com.mugen.myteam.View.MillosProgressDialog;
 ...
 */
public class TeamsListFragment extends RefreshableFragment implements ViewOps.MainOps {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState){
        ...
        ApiManager apiManager = new ApiManager(new DownloadTeamsHandler(lock, view.getContext()));
    ...
    public class ListHandler extends AsyncTask<Void,Void,List> {
        ...
        protected List doInBackground(Void... params) {
            ...
            return new DataBaseManager().getTeams(getActivity());
        }
    }
