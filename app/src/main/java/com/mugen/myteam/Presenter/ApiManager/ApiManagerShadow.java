...
public class ApiManagerShadow extends ApiManager {
    ...
    public static final String DBSHADOW="[\n" +
            ...
            ");\n" +
            "INSERT INTO championships_match VALUES (2,'2015-01-08 21:43:06',1,3,1,2,3,1,42,1);\n" +
            "INSERT INTO championships_match VALUES (3,'2015-01-07 22:09:06',1,5,1,4,2,2,42,1);\n" +
            "INSERT INTO championships_match VALUES (4,'2015-01-15 21:43:06',2,2,1,5,1,3,42,1);\n" +
            "INSERT INTO championships_match VALUES (5,'2015-01-16 22:09:06',2,4,1,3,1,2,42,1);\n" +
    ...
    public ApiManagerShadow(ResponseHandlerInterface handler) {
        super(handler);
    }
