...
public class ApiManagerShadow extends ApiManager {
    ...
    public static final String DBSHADOW="BEGIN TRANSACTION;\n" +
            ...
            ");\n" +
            "CREATE INDEX \"championships_match_champion_local_team_id_2b6196acd4159104_fk_championships_team_id\" ON \"championships_match\" (\"local_team_id\");\n" +
            "CREATE INDEX \"championships_match_champi_visitor_team_id_566ee70f5adef619_fk_championships_team_id\" ON \"championships_match\" (\"visitor_team_id\");\n" +
            "CREATE INDEX \"championships_match_champion_stadium_id_5330b18ac038417b_fk_championships_stadium_id\" ON \"championships_match\" (\"stadium_id\");\n" +
            "CREATE INDEX \"championships_championship_team_championship_id\" ON \"championships_championship_team\" (\"championship_id\",\"team_id\");\n" +
            "CREATE INDEX \"championships_championship_team_championships__team_id_6e6e7f684c347268_fk_championships_team_id\" ON \"championships_championship_team\" (\"team_id\");\n" +
